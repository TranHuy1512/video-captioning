...
def dataloader_youcook_train(args, tokenizer, llama_tokenizer=None):
...
def dataloader_youcook_test(args, tokenizer, logger, llama_tokenizer=None):
    max_txt_len = getattr(args, 'max_txt_len', 32)
...
def dataloader_msrvtt_train(args, tokenizer, llama_tokenizer=None):
    max_txt_len = getattr(args, 'max_txt_len', 32)
...
def dataloader_msrvtt_test(args, tokenizer, logger=None, split_type="test", llama_tokenizer=None):
    max_txt_len = getattr(args, 'max_txt_len', 32)
    use_small_dataset = getattr(args, 'use_small_dataset', False)
