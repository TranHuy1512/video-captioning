...
class MSRVTT_Caption_DataLoader(Dataset):
    ...
    def _get_text(self, video_id, caption=None):
        ...
        pairs_llama_output_caption_ids = np.zeros((k, llama_max_len), dtype=np.int64)
        pairs_llama_output_caption_mask = np.zeros((k, llama_max_len), dtype=np.int64)
    ...
    def __getitem__(self, idx):
        ...
        pairs_llama_output_caption_ids, pairs_llama_output_caption_mask = self._get_text(video_id, caption)
        ...
        return pairs_text, pairs_mask, pairs_segment, video, video_mask, \
               ...
               pairs_llama_output_caption_ids, pairs_llama_output_caption_mask, idx
